...
# DEVICE_TOKEN = "eUAO6CUZSBSPHkI2DFoEw9:APA91bE42lVTISBVP1-v_L-owWhoSzkc-3SShUyH_51Zjzw2QTd2nXpULBranWCWla0sd"
DEVICE_TOKEN = "c9WHtpgiT1CiWZr00fOcjy:APA91bFFpXh5bAoYZo_ArJk8yH6vNq92Nxi5eZXVonuYGIu-omD0F9_VBPi3sZllcEotGfCsGnEivoCYSBrm713NOC9oZr-yOCzUnwNS6QV6GN8uUJhxBXs"
...
def send_notification(device_token: str, title: str, body: str, data: dict = None):
...
send_notification("dmcEY_XPSOOqHjRZ0fcISr:APA91bGZzO4WRYz9s4WREPEf_hOWI-jSLDdBg9nQSg9WBfhKOVC9wUzm2QzwCEPkidKsPddI_m3-DbzS2lQQLudlX8hiI4z9wqeIBKfBmhdRTIKLWkejWDM", "MoM Fit", "تمرینای امروز رو انجام دادی یا نه علیرضا")